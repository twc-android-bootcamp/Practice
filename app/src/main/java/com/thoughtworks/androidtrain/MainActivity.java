...
import com.thoughtworks.androidtrain.uiflow.SpActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI() {
        ...
        Button btnSp = findViewById(R.id.sp);
        btnSp.setOnClickListener(v -> startActivity(new Intent(this, SpActivity.class)));
    }
